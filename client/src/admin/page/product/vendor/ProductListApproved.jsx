...
import ProductStats from '@/admin/components/ProductStats';
...
const ProductListApproved = () => {
	...
	const { data: statsData, isLoading: statsLoading } = useAppQuery(
		['products-stats'],
	...
	// Đếm số lượng sản phẩm theo trạng thái từ stats API
					...
					<div className='flex items-center justify-center space-x-1'>
						...
						<Tooltip content='Xem chi tiết'>
							<Button
								...
								className='p-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 border-0 shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md'>
							...
							<>
								<Tooltip content='Phê duyệt'>
									<Button
										...
										className='p-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 border-0 shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md'>
								...
								<Tooltip content='Từ chối'>
									<Button
										...
										color='failure'
										onClick={() =>
											handleActionModal(product, 'reject')
										}
										className='p-2 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 border-0 shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md'>
						...
						<Tooltip content='Chỉnh sửa'>
							<Button
								...
								className='p-2 bg-gradient-to-r from-yellow-500 to-orange-600 hover:from-yellow-600 hover:to-orange-700 border-0 shadow-sm transition-all duration-200 hover:scale-110 hover:shadow-md'>
