...
const ProductListRequest = () => {
	...
	const [actionType, setActionType] = useState('APPROVED'); // Trạng thái duyệt
	...
	const queryParams = useMemo(() => {
		...
		return params;
	}, [currentPage, itemsPerPage, debouncedKeyword, status, sortBy, category]);
	...
	const renderRow = (product, index) => {
		...
		return (
			<tr
				...
				className='hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 border-b border-gray-100 group w-full'>
				{/* Serial Number */}
