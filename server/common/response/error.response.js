...
class UnauthorizedError extends ErrorResponse {
	constructor(message = HttpMessage.UNAUTHORIZED, status = HttpStatusCode.UNAUTHORIZED) {
		super(message, status);
	}
}
...
class NotFoundError extends ErrorResponse {
	constructor(message = HttpMessage.NOT_FOUND, status = HttpStatusCode.NOT_FOUND) {
		super(message, status);
	}
}

class ConflictError extends ErrorResponse {
	constructor(message = HttpMessage.CONFLICT, status = HttpStatusCode.CONFLICT) {
		super(message, status);
	}
}
